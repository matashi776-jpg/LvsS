...
### HoMM-стиль: лінійна битва
На початку кожного бою три **Бойових Гусаки** автоматично розставляються на трьох лініях (Y: 150, 300, 450). Вони мають idle-анімацію «дихання» (tween yoyo) зі зміщеною фазою, як у Heroes of Might & Magic. Юніти стріляють автоматично в першого ворога на своїй лінії.

### D&D інвентар (UIScene)
Додаткові башти (Гусак або Борщова Гармата) можна перетягнути з нижньої панелі на будь-яку точку лінії. Башта прив'язується до найближчої лінії і починає стріляти.
